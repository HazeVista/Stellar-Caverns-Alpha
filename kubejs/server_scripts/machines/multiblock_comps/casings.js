ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('assemble_steam_casings')
        .itemInputs('gtceu:steel_frame', 'minecraft:deepslate')
        .itemOutputs('kubejs:high_steam_machine_casing')
        .circuit(6)
        .duration(50)
        .EUt(16)

    event.shaped('4x kubejs:high_steam_machine_casing', [
        'ABA',
        'BCB',
        'ABA'
    ], {
